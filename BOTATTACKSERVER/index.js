...
function createBot() {
    ...
    bot.on('error', (err) => {
        ...
        // Aquí puedes agregar lógica para manejar el error, como intentar reconectar.
        // Por ejemplo, puedes llamar a createBot() nuevamente.
        createBot();
    });

    bot.on('end', () => {
        console.log('Bot desconectado. Intentando reconexión...');
        // Aquí también puedes intentar reconectar llamando a createBot().
        createBot();
    });
}
            ...
            for (let i = 0; i < repeatCount; i++) {
                if (isConnected) {
                    if (eventType === 'gift') {
                        ...
                        }, 1500); // Esperar 3 segundos (3000 milisegundos) antes de enviar el comando
...
// Comando para registrar todos los mensajes en la consola del bot
